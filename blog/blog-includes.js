/* ============================================================
   SYRACUSE GRAND — Blog page chrome (header, footer, mobile bar)
   This is a sibling of /includes.js with parent-relative paths
   so blog posts at /blog/*.html can use the same shared chrome.
   ============================================================ */
